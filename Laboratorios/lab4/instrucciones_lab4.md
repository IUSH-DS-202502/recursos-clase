...
Enlace a los enunciados: [`lab4.xml`](https://github.com/IUSH-DS-202502/recursos-clase/blob/main/Laboratorios/lab4/lab4.xml)
...
1. **Desarrollo del Algoritmo**:
   ...
   - Para el desarrollo de este laboratorio NO SE PODRÁ HACER USO DE NINGUNA ESTRUCTURA TIPO ÁRBOL O GRAFO con excepción de aquellas que sean implementadas por usted como parte del laboratorio y que **sea coherente y correspondiente con lo visto en clase**.
     - En síntesis, lo que se espera es que usted haga uso de la clases Árbol, ÁrbolAVL, MinHeap,MaxHeap, Grafo como lista de adyacencia, o matriz de adyacencia que USTED implemente con base en lo visto en el curso.

2. **Archivos del Laboratorio**:
   - Para este laboratorio solo está disponible el archivo [`lab4.xml`](https://github.com/IUSH-DS-202502/recursos-clase/blob/main/Laboratorios/lab4/lab4.xml).
...
1. **Formato y Nombre del Archivo**:
   ...
   - Es crucial que **conserves el nombre original** del archivo (`lab4.xml` ).
...
4. **Fecha máxima de envío:**:
   - 16 de Noviembre del 2025 a las 23:59:59 PM
